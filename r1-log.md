...
### R1D83
Today I worked on a couple of VueJS examples for the course I'm preparing for my colleagues. Still some simple examples to explore the basics of Vue.
...
### R1D74
Today I kept studying VueJS and doing some exercises. I also kept watching @youyuxi [Advanced Vue.js Features from the Ground Up](https://frontendmasters.com/courses/advanced-vue/) on [@FrontendMasters](https://twitter.com/FrontendMasters).
...
### R1D66
Today I read a bit of `this & Object Prototypes` [@YDKJS](https://twitter.com/YDKJS) and kept working on my Vue/Nuxt project. I'm adding pages modules but I'm not sure if the [WP GraphQL plugin](https://github.com/wp-graphql/wp-graphql) is mature enough for my project. I may have to revert back to the Wordpress API instead. I also joined [@jjeadon](https://twitter.com/jjeadon) on a [@codebuddiesmeet](https://twitter.com/codebuddiesmeet) session about Command Line Basics.
...
### R1D52
Today it was a more theoretical study day. I read some bits of [@YDKJS](https://twitter.com/YDKJS) and started reading [JavaScript Allongé – the "Six" Edition](https://leanpub.com/javascriptallongesix/read). I did lots of the proposed exercises to follow along and learned some new things about JS along the way. I also worked a bit on the React Version of my Local Weather app.

### R1D51
Today I finished the jQuery version of my Local Weather app and starte the React version. I also started reading `this & Object Prototypes` [@YDKJS](https://twitter.com/YDKJS) book.

### R1D50
Hurray, half way there!!! Today I finished the clean up on the [vanilla JavaScript version of my Local Weather app](https://codepen.io/gepetobio/full/vdyzjq/) and started the jQuery version. I also finished reading Scope & Closures [@YDKJS](https://twitter.com/YDKJS) book.
...
### R1D45 
Once more, today I read a bit of [@YDKJS](https://twitter.com/YDKJS) and did more functional programming exercises with the nodeschool Functional JavaScript workshop. Also did a code review session with [@artoo_O](https://twitter.com/artoo_O). Tomorrow I'll probably get back to my Local Weather app.

### R1D44 
Same as yesterday, today I read a bit of [@YDKJS](https://twitter.com/YDKJS) and did more functional programming exercises with the nodeschool Functional JavaScript workshop.

### R1D43 
Today, again, I read a bit of [@YDKJS](https://twitter.com/YDKJS) and did more functional programming exercises with the nodeschool Functional JavaScript workshop.
...
### R1D7
Today I managed to refactor my piece of code from yesterday and it works without bugs! Tests all green, hurray! Also started to build my FCC portfolio page. I've been sharing a google hangout link for the last 4 or 5 days and today I met some cool guys - [@artoo_O](https://twitter.com/artoo_O) [@jjeadon](https://twitter.com/jjeadon) [@warbornx](https://twitter.com/warbornx) and [@super_raay](https://twitter.com/super_raay).
